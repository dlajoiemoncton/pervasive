...
#'
#' @export
pervasive_tric_glm <- function(formula, data, min_support) {
  ...
  class(result) <- "pervasive_tric_glm"
  return(result)
}

#' @export
# Custom print function for pervasive object
print.pervasive_tric_glm <- function(x, ...) {
  cat("\nThe observed percentage of concordant pairs (OPCP) is",
